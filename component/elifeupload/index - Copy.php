<?php
	...
	if(FILE_SERVER != "")
	{
		header( 'Location: '.FILE_SERVER.'component/elifeupload/index.php?site='.md5(SKINID) ) ;
	}
?>
<!DOCTYPE HTML>
<!--
...
<div id="index" class="container">
    ...
    <form id="fileupload" action="<?php echo DIR_FILE?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row fileupload-buttonbar">
            <div class="span7">
            	<span><b style="float:left; padding:6px">Danh sách tập tin đã upload</b></span>
                <a class="btn btn-success" onClick="toggleuploadpanel()">
                	<i class="icon-plus icon-white"></i>
                    <span>Thêm file mới...</span>
                </a>

                <button type="button" class="btn btn-primary select pull-right" style="width:150px; margin-left:10px">
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-download fade">
        {% if (file.error) { %}
            ...
            <td class="error" colspan="2"><span class="label label-important">Error</span> {%=file.error%}</td>
        {% } else { %}
			<td class="checkselect"><input type="checkbox" name="delete" data-url="upload/{%=file.name%}" value="1"></td>
