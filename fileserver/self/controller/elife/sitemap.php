...
class ControllerElifeSitemap extends Controller
{
	...
	public function save()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm($data)) {
			...
			$this->smartweb->saveSEOURL($data['sitemap']['seo_url'],"sitemap",$sitemapid);
	...
	function validateForm($data)
	{
		...
		if($data['sitemap']['seo_url'] != "" )
		{
			if($this->smartweb->checkSEOURL($data['sitemap']['seo_url'], "sitemap", $data['sitemap']['sitemapid']) == false)
			{
