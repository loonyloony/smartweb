...
class ControllerProductProduct extends Controller
{
	...
	private function getList() 
	{
		...
		$this->data['insert'] = $this->url->http('module/optionproduct/insert&sitemapid='.$this->request->get['sitemapid']);
		$this->data['delete'] = $this->url->http('optionproduct/delete');
		...
		//for($i=0; $i <= count($this->data['datas'])-1 ; $i++)
		{
			...
			$this->data['datas'][$i]['link_edit'] = $this->url->http('module/optionproduct/update&productid='.$this->data['datas'][$i]['productid'].'&sitemapid='.$this->request->get['sitemapid']);						
		}
	...
	private function getForm()
	{
		...
		if ((isset($this->request->get['productid'])) ) 
		{
			...
			//load product option
			$this->data['product_option'] = $this->model_product_product->getProductOptionByProductId($this->data['product']['productid']);
	...
	public function getOptionValueByOptionid(){
		...
		$arrayOfOptionValue = $this->model_product_product->getOptionValueByOptionid($data);
