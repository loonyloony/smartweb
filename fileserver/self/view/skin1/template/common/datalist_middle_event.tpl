          ...
          <table class="example data-table">
            <thead>
              <tr>
                ...
                <th width="150px"><?php echo $column_image ?></th>
            ...
            <tbody>
              ...
              <tr class="<?php echo ($index % 2 == 1 ? 'even' : 'even') ?>">
                <td>
                <input name="delete[<?php echo $item['mediaid'] ?>]" type="checkbox" value="<?php echo $items[$i]['mediaid'] ?>" /><input type="text" name="position[<?php echo $items[$i]['mediaid']?>]" class="text" size="2" value="<?php echo $items[$i]['position']?>"   />
                </td>
                <td>
               		 <a class="elife-table-title" href="<?php echo $items[$i]['link'] ?>#tabedit"><?php echo $items[$i]['title'] ?></a>
                     <div style="color:#009;font-style:italic;margin-left:10px"> Ngày giờ bắt đầu &nbsp; :&nbsp;  <?php echo $items[$i]['event']['starthour']?>  &nbsp; &nbsp; <?php echo $items[$i]['event']['startdate']?> <br /> Ngày giờ kết thúc :  &nbsp; <?php echo $items[$i]['event']['endhour']?>  &nbsp; &nbsp;  <?php echo $items[$i]['event']['enddate']?> </div>
                </td>
               
                <td class="ben-text-center"><img src="images/resizepng-150x100/<?php echo $items[$i]['imagepath'] ?>" /></td>
