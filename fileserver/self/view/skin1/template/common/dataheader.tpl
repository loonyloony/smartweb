...
<div class="ben-table-header-framework" class="ben-list-frame-work">
    <div class="left" >
        <a href="#" class="button btnTimKiem"><img src="view/skin1/image/button/search.png" /><?php echo $button_find?></a>
        <a href="<?php echo $link_xemtatca ?>" class="button"><img src="view/skin1/image//button/viewall.png" /><?php echo $button_viewall ?></a>
    </div>
    <div class="right" >
        Sắp xếp theo:
        ...
        <a href="#" class="button" onclick="$('#dataheader').submit()"><img src="view/skin1/image//button/sort.png" /><?php echo $button_sort ?></a>
    </div>
