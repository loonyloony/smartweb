<div class="section">
    ...
    <div class="section-content">
        ...
        ?>
                    <tr>
                        <td class="check-column"><input class="inputchk <?php echo $user['username']?>" type="checkbox" name="delete[<?php echo $user['userid']?>]" value="<?php echo $user['userid']?>" ></td>
                        
                        <td><?php echo $user['username']?></td>
                        <td><?php echo $user['fullname']?></td>
                		<td><?php echo $user['text_st']?></td>
                        <td class="link-control">
                            <a class="button" href="<?php echo $user['link_edit']?>" title="<?php echo $button_edit?>"><?php echo $button_edit?></a>
