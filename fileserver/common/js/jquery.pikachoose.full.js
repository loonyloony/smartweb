    ...
    $pc.fn.extend({
        ...
        build: function() {
       	...
       	//create the structure for pikachoose
            ...
            //alert(this.active.attr('src'));
            //$(".pop_zoom").attr('href',this.active.attr('src'));
            //$(".pop_zoom").attr('href',$(this).active.attr('src'));
            $("a[rel='1']").css('display','block');
         ...
         */
	     imgClick: function(e,x) {         
            ...
            //alert($(this).attr('src'));
            $(".btn_custom > a.zoombox").css('display','none');
            $("a[rel='"+$(this).parent().parent().attr('jcarouselindex')+"']").css('display','block');
