...
function Messi(data, options) {
  ...
  if(_this.options.buttons.length > 0) {
    ...
    for (var i = 0; i < _this.options.buttons.length; i++) {
      ...
      var btn = jQuery('<div class="btnbox"><button myval="'+ val+'" class="btn ' + cls + '" href="#">' + _this.options.buttons[i].label + '</button></div>').data('value', _this.options.buttons[i].val);
      btn.on('click', 'button', function() {
        var value = $(this).attr('myval');
