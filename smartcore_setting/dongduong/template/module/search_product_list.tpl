        ...
        <div class="elife-wrapper">
            <form>
                <div class="elife-product-sort elife-left">
                    ...
                    <input type="radio" name="order" class="order" id="DESC" value="DESC" > <label for="input-5" class="radio">Z-A</label>
                    ...
                    <li id="productid" class="product">
                        <div class="product-image">
                            <a class="product-link" href="<?php echo $item['link'] ?>" title="<?php echo $item['name'] ?>">
                                ...
                                <img height="182px" alt="<?php echo $item['name'] ?>" src="images/fixsize-182x182/<?php echo $item['image']?>">
                            </a>
                        </div>
