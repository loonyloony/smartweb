...
<form id="frm_setting" name="frm" method="post" enctype="multipart/form-data">
	<div class="section-title">
        <div class="left titletext"><?php echo $heading_title?></div>
        <div class="button right">
            <input type="button" onclick="save_setting()" value="<?php echo $button_save ?>" class="button"/>
...
function save_setting() {
	$.post("<?php echo $action?>", $("#frm_setting").serialize(), function(data){
		if(data == "true") {
			alert("<?php echo $announ_update_success ?>");
			location.href = "<?php echo $this->url->http('core/message') ?>"	
		} else {
