        ...
        <div>
            ...
            <table class="data-table" width="100%">
            	...
            	<thead>
                    ...
                    <th width="30%"><?php echo $label_support_online_name ?></th>
                ...
                <tbody>
                	...
                	<tr class="<?php echo $class; ?>">
                    	<td><input class="inputchk" type="checkbox" name="delete[<?php echo $item['supportid']?>]" value="<?php echo $item['supportid']?>" ></td>
                        <td><?php echo $item['addonid'] ?></td>
                    	<td><?php echo $item['title']?></td>
                        <td><?php echo $item['skype']?></td>
                        <td><?php echo $item['yahoo'] ?></td>
                        <?php if($_GET['dialog'] != "true"){ ?>
                         <td><input type="text" class="text" value="<?php echo $item['sortorder'] ?>" name="sortorder[<?php echo $item['supportid'] ?>]" /></td> 
                        <td>
...
function sortOrderItems()
{
	...
	$.post("?route=sidebar/supportonline/sortorder", 
			$("#postlist").serialize(), 
			function(data)
			{
				if(data == "true")
