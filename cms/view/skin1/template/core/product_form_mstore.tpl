		...
		<div id="container">           
        	...
        	<div>
            	<table>
                    ...
                    <tr>
                    	<td><label><?php echo $label_product_saleoff_price ?>:</label></td>
                        <td><input type="text" name="saleoff" value="<?php echo $product['saleoff']?>" class="text number"  style="width:290px" /></td>
                    </tr>
                ...
                <div>
                	<table>
                        ...
                        <tbody id="listProductAttribute">
                            	<tr id="rowProductAttribute0">
                                	<td>
                                    <?php echo $product_attribute[0]['name'] == '' ? 'brand' : $product_attribute[0]['name'] ?>
                                    	<input type="hidden" class="text" size="40" name="product_attribute[0][name]" value="<?php echo $product_attribute[0]['name'] == '' ? 'brand' : $product_attribute[0]['name'] ?>" />
                                    </td>
                                    <td>
                                    <?php if(isset($language)){ 
                            			foreach($language as $languageid => $item){
                                    ?>
                                    	<textarea class="text" name="product_attribute[0][product_attribute_description][<?php echo $languageid ?>][description]" style="width: 300px"><?php echo $product_attribute[0]['product_attribute_description'][$languageid]['description'] ?></textarea><img src="<?php echo HTTP_SERVER . DIR_IMAGE . $languageid ?>.jpg" />
                                    <?php } } ?>
                                    </td>
                                    <td><!--<a class="button" onclick="deleteProductAttribute(<?php echo $temp ?>)"><?php echo $button_delete ?></a>--></td>
                                </tr>
                                <tr id="rowProductAttribute1">
                                	<td>
                                    <?php echo $product_attribute[1]['name'] == '' ? 'origin' : $product_attribute[1]['name'] ?>
                                    	<input type="hidden" class="text" size="40" name="product_attribute[1][name]" value="<?php echo $product_attribute[1]['name'] == '' ? 'origin' : $product_attribute[1]['name'] ?>" />
                                    </td>
                                    <td>
                                    <?php if(isset($language)){ 
                            			foreach($language as $languageid => $item){
                                    ?>
                                    	<textarea class="text" name="product_attribute[1][product_attribute_description][<?php echo $languageid ?>][description]" style="width: 300px"><?php echo $product_attribute[1]['product_attribute_description'][$languageid]['description'] ?></textarea><img src="<?php echo HTTP_SERVER . DIR_IMAGE . $languageid ?>.jpg" />
                                    <?php } } ?>
                                    </td>
                                    <td><!--<a class="button" onclick="deleteProductAttribute(<?php echo $temp ?>)"><?php echo $button_delete ?></a>--></td>
                                </tr>
                                <tr id="rowProductAttribute2">
                                	<td>
                                    	<?php echo $product_attribute[2]['name'] == '' ? 'size' : $product_attribute[2]['name'] ?>
                                        <input type="hidden" class="text" size="40" name="product_attribute[2][name]" value="<?php echo $product_attribute[2]['name'] == '' ? 'size' : $product_attribute[2]['name'] ?>" />
                                    </td>
                                    <td>
                                    <?php if(isset($language)){ 
                            			foreach($language as $languageid => $item){
                                    ?>
                                    	<textarea class="text" name="product_attribute[2][product_attribute_description][<?php echo $languageid ?>][description]" style="width: 300px"><?php echo $product_attribute[2]['product_attribute_description'][$languageid]['description'] ?></textarea><img src="<?php echo HTTP_SERVER . DIR_IMAGE . $languageid ?>.jpg" />
                                    <?php } } ?>
                                    </td>
                                    <td><!--<a class="button" onclick="deleteProductAttribute(<?php echo $temp ?>)"><?php echo $button_delete ?></a>--></td>
                                </tr>
