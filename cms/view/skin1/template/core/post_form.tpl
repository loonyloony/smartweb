    ...
    $.ajax({
			...
			success: function(html)
			{
				$("#alias").val(html);
                    ...
                    <p>
                    	<label><?php echo $lbl_color ?></label>
                        <div id='sc-block'>
                            <?php foreach($color as $item){ ?>
                                <div class="left">
                                    <input type="checkbox" name="colorproduct[<?php echo $item['id']?>]" value="<?php echo $item['id']?>" style="float:left;" <?php echo in_array($item['id'],$colors)?'checked="checked"':''; ?> />
                                    <div class="color">
                                        <a style="display:block;background:none repeat scroll 0 0 <?php echo $item['colorcode']?>"></a>
                                    </div>
                                </div>
                                
                                
                                
                                <!--<div id="swatch1" class="sc"><a style="display:block;background:none repeat scroll 0 0 green"></a></div>-->
                            <?php } ?>
                        	<div class="clearer"></div>
                        </div>
                        <script type="text/javascript">
							$('#swatch0').click(function(){
                       ...
                       <!-- <p>
                        ...
                        <p>
                            ...
                            <input class="text elife-datepicker" type="text" name="eventdate" value="<?php echo $this->date->formatMySQLDate($eventdate)?>" />
                        </p>
                        <p>
