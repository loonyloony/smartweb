            ...
            <div>
            	<table>
                    ...
                    <tr>
                    	...
                    	<td><label><?php echo $label_as_shown ?></label></td>
                        <td>
                        	<select name="asshown">
                            	<option value="none" <?php if($module['asshown']=='none') echo "selected"?>> -- None -- </option>
                                <option value="list" <?php if($module['asshown']=='list') echo "selected"?>> -- List -- </option>
                                <option value="list,detail" <?php if($module['asshown']=='list,detail') echo "selected"?>> -- List, Detail -- </option>
                                <option value="list,list,detail" <?php if($module['asshown']=='list,list,detail') echo "selected"?>> -- List, List, Detail --</option>
                            </select>	
                        </td>
                    <tr>
