<?php 
if (SKINID == 'mstore') 
	include('product_form_mstore.tpl');
elseif (SKINID == 'tphone') 
	include('product_form_tphone.tpl');
elseif (SKINID == 'dongduong') 
	include('product_form_dongduong.tpl');
else {
?>
		...
		<div id="container">           
        	...
        	<div>
            	<table>
                    ...
                    <!-- manufacturer -->
                    <?php if(SKINID == 'mstore' || SKINID == 'fanhanghieu') { ?>
                    <tr>
                    ...
                    <?php } ?>
                 	...
                 	<tr>
                        <td><label><?php echo $label_filter_types ?>:</label></td>
                        <td><select id="filterRoot" name="filterRoot"><?php echo $boxfilter ?></select> <select id="filter" name="filter"><?php echo $boxfilteroption ?></select></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="text" id="color" name="color" value="<?php echo $product['color']?>" class="text"  style="width:290px" /><br/>
                            <span>example: red, blue, yellow</span>
                       	</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="text" id="size" name="size" value="<?php echo $product['size']?>" class="text"  style="width:290px" /><br/>
                            <span>example: S, M, L, XL</span>
                       	</td>
                    </tr>
                    <?php }?>
                    ...
                    <?php if(SKINID == 'mesushop' || SKINID == 'hatomex' || SKINID == 'fanhanghieu') { ?>
                    <tr>
