		...
		<div id="container">           
        	...
        	<div>
            	<table>
                    ...
                    <?php if(SKINID == 'tphone') { ?>
					<tr>
						<td><label><?php echo 'Bảo hành' ?>:</label></td>
						<td><input type="text" name="goodsstatus" value="<?php echo $product['goodsstatus']?>" class="text number"  style="width:75px" /></td>
					</tr>
                    <tr>
