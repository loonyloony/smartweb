...
<head>
    ...
    <script language="javascript">
		...
		var SKIN_PATH = "<?php echo $this->smartweb->skinpath?>/css/00elife_editor.css";
	</script>
...
<body>
    ...
    <form name="upload_return_form" style="display:none">
    	<input id="upload_return" name="upload_return" value="" />
    </form>
</body>
