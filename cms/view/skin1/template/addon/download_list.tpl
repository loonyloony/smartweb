...
<div class="section">
    ...
    <div class="section-title">
    	 <div class="left titletext">Download</div>
        ...
        <div>
            ...
            <table class="data-table" width="100%">
            	...
            	<thead>
                    ...
                    <th width="15%"><?php echo $text_title ?></th>
                    <th width="20%"><?php echo $text_description ?></th>
                ...
                <tbody>
                	...
                	<tr class="<?php echo $class; ?>">
                        ...
                        <td>
                            <?php if(count($item['weblink']) > 0){ foreach($item['weblink'] as $items) { ?>
                            - <a href="images/root/<?php echo $items['image'] ?>" target="_blank"><?php echo $items['title'] ?></a> <br />
                            <?php } } ?>
                        </td>
                        <td>
