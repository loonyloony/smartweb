	...
	<div class="section-content padding1">
        ...
        <div id="container">
            ...
            <?php 
                ...
                if(in_array("tab_summary",$arr_tabs)){
                    include(DIR_TEMPLATE."media/form_tab_summary.tpl");
                }
                ...
                if(in_array("tab_partnerslink",$arr_tabs)){
                    include(DIR_TEMPLATE."media/form_tab_information.tpl");
                }
                
                if(in_array("tab_subinformation",$arr_tabs)){
                    include(DIR_TEMPLATE."media/form_tab_subinformation.tpl");
                }
                
                if(in_array("tab_tag",$arr_tabs)){
                    include(DIR_TEMPLATE."media/form_tab_tag.tpl");
                }
