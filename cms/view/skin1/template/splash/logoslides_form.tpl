                        ...
                        <td>
                        	...
                        	<table>
                            	<tr>
                                    ...
                                    <td>
                                    	<img id="imagepreview" imagetype="images/resizepng-160x120" src="images/resizepng-160x120/<?php echo $weblink['image']?>" />
...
function save()
{
	...
	$.post("?route=splash/logoslides/save", $("#frm").serialize(),
		function(data){
			if(data == "true")
			{
				var url = "";
				...
				window.location = "?route=splash/logoslides" + url;
			}
			else
			{
