                ...
                <div id="multilang">
                    ...
                    <div id="tab-edit<?php echo $key ?>">
                        ...
                        <table>
                            ...
                            <tr>
                                <td width="100px"></td>
                                <td><input type="hidden" name="weblink_description[<?php echo $key ?>][link]" value="<?php echo $weblink_description[$key][link] ?>" class="text" size=60 /></td>
                            </tr>
                            <?php } else { ?>
                            <tr>
                                <td width="100px"><label><?php echo $label_link ?></label></td>
                                <td><input type="text" name="weblink_description[<?php echo $key ?>][link]" value="<?php echo $weblink_description[$key][link] ?>" class="text" size=60 /></td>
                            </tr>
                            <?php } ?>
                            <tr>
