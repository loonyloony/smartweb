...
<div class="section" id="sitemaplist">
    ...
    <div class="section-content padding1">
        	...
        	<div>        
                ...
                <p>
                    <label>Point</label>
                    X:<input type="text" name="x" value="<?php echo $locationmap['x']?>"  class="text"/> 
                    Y:<input type="text" name="y" value="<?php echo $locationmap['y']?>"  class="text" onchange="loadPosition()"/>
                ...
                <p>
                    <label>Zoom</label><br />
                    <input type="text" name="zoom" value="<?php echo $locationmap['zoom']?>" class="text" size=60 readonly="readonly"/>
                </p> 
            </div>
