...
function save(){
	...
	showloading();
	var url="?route=module/download/save";
	var arr_language=<?php echo json_encode($arr_language) ?>;
	for(var x in arr_language){
...
function Attachment()
{
	...
	this.addImageSub=function(iid,name,path,thums){
		...
		var control='<a class="btndeleteimage"><img src="<?php echo HTTP_SERVER.DIR_IMAGE ?>button/delete.png" width="32" height="24"  /></a>';
