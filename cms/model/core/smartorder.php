...
class ModelCoreSmartorder extends Model 
{
	...
	public function delete($orderid) {
		...
		$this->db->deleteData("order", " orderid = '" . $orderid . "'");
		$this->db->deleteData("order_product", "orderid = '". $orderid. "'");
	}
	...
	public function checkFanByCustomerPoint($point)
	{
		$sql = "SELECT * FROM `bonus_group` WHERE `point` <= '" . $point . "' ORDER BY point DESC";
		$query = $this->db->query($sql);
