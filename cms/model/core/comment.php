...
class ModelCoreComment extends Model{
	...
	public function approveItem($id) {
		...
		$where1 = " comment_id = '".$id."' AND `id` = `comment_id` ";
		$where2 = " comment_id = '".$id."' AND `id` != `comment_id` ";
		
		$this->db->updateData("comment",$field,$value1,$where1);
		$this->db->updateData("comment",$field,$value2,$where2);
	}
