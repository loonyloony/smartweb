...
class ModelProductProduct extends Model{
	...
	public function insert($data){
		...
		if(isset($data['product_description'])){
			foreach($data['product_description'] as $languageid => $item){
				...
				//url_alias
				if($seo_url != ""){
					$this->smartweb->saveSEOURL($seo_url,"productoption",$productid,$languageid);
				}
	...
	********************************************/
	public function update($data){
		...
		//collection info for advance search
		$rootcontent_search .= $model."##".$seo_url."##".$location."##";
	...
	********************************************/
	...
	public function delete($productid){
		...
		$this->db->query("DELETE FROM `url_alias` WHERE value = '" . $productid . "' AND object = 'productoption' ");
	}
