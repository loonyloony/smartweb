...
<input type="text" id="searchKeyword" name="keyword" value="<?php echo urldecode($_GET['keyword']) ?>" placeholder="Enter your keywords..." style="padding: 5px; width: 140px; border-radius: 5px; border:1px solid #000;">
