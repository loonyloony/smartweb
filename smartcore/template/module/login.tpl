...
<div id="frm-login" class="right">
    ...
    <div class="forgot">
        ...
        <br /><a href="<?php echo HTTP_SERVER ?>?route=common/forgotpassword"><?php echo $text_forgetpass ?></a> | <a href="<?php echo HTTP_SERVER ?>dang-ki.html"><?php echo $text_register ?></a>
    </div>
    <div class="btn-login">
        <a class="elife-button" id="button-login" ><?php echo $button_login ?></a>
    </div>
</div>
<?php } ?>
<script>
