<?php
class ControllerDashboardHotproducttag extends Controller
{

    public function index()
    {
        $this->getList();
        $this->template = "module/newproduct_list.tpl";
        $this->id = "content";
        $this->render();
    }
    ...
    private function getList()
    {
        ...
        // get tags
        $this->getTags("new product");
        $this->getListMonth($this->smartweb->sitemap['sitemapid']);
        $this->getListManArea(" AND pd.tag LIKE '%new product%' ");
        ...
        $where = " AND pd.tag LIKE '%new product%' ";
        if ($date != "") {
