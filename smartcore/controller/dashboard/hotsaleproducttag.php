<?php
class ControllerDashboardHotSaleproducttag extends Controller
{

    public function index()
    {
        $this->getList();
        $this->template = "module/hotsaleproduct_list.tpl";
        $this->id = "content";
        $this->render();
    }
    ...
    private function getList()
    {
        ...
        // get tags
        $this->getTags("hot sale");
        $this->getListMonth($this->smartweb->sitemap['sitemapid']);
        $this->getListManArea(" AND pd.tag LIKE '%hot sale%' ");
        ...
        $where = " AND pd.tag LIKE '%hot sale%' ";
        if ($date != "") {
