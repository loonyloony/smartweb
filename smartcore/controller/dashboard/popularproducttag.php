<?php
class ControllerDashboardPopularproducttag extends Controller
{

    public function index()
    {
        $this->getList();
        $this->template = "module/popularproduct_list.tpl";
        $this->id = "content";
        $this->render();
    }
    ...
    private function getList()
    {
        ...
        // get tags
        $this->getTags("popular product");
        $this->getListMonth($this->smartweb->sitemap['sitemapid']);
        $this->getListManArea(" AND pd.tag LIKE '%popular product%' ");
        ...
        $where = " AND pd.tag LIKE '%popular product%' ";
        if ($date != "") {
