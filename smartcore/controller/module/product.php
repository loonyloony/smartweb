...
class ControllerModuleProduct extends Controller
{
    ...
    public function index()
    {
        ...
        if (SKINID == "fanhanghieu") {
            ...
            $this->data['pageURL'] = $this->url->getURL($this->data['product']['seo_url'], 'product', $this->data['product']['productid']);
    ...
    private function getList()
    {
        ...
        if ($sitemapFilter != '') {
            ...
            $arrayOfProduct = $this->model_core_product->getList($where, false);
        }
        ...
        if ($sitemapFilter != '') {
            ...
            $result = $this->model_core_product->getPageListWithFilter($where, $page, $lastPage, $itemsPerPage, $filterString);
        }
    ...
    private function getProduct()
    {
        ...
        if (SKINID == "mesushop") {
            ...
            $this->data['products'] = $this->model_core_product->getList(" AND p.productid <> '" . $this->smartweb->objectid . "' ORDER BY p.date_added DESC Limit 0,8 ");
        } else {
