<?php
class ControllerSplashCustomsplash extends Controller
{
    public function index()
    {
        $this->load->model("core/product");
        $this->data['products'] = $this->model_core_product->getGroupList(" AND p.image not like '' ORDER BY date_modified DESC LIMIT 0,6 ");
