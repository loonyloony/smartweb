...
class ControllerLayoutPrint extends Controller
{
	public function index()
	{
		...
		if($this->data['meta_description'] == ""){
			$this->data['meta_description'] = $this->config->get('config_description');	
		}
		$this->data['meta_keywords'] = $this->document->getKeywords();
		if($this->data['meta_keywords'] == ""){
			$this->data['meta_keywords'] = $this->config->get('config_keywords');	
		}
		...
		if($this->data['og_image'] == ""){
			$this->data['og_image'] = $this->config->get('config_logo');	
		}
